    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Максимумм до 256 символів', max_length=256, verbose_name='Заголовок')),
                ('description', models.TextField(blank=True, verbose_name='Опис')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2021, 11, 15, 12, 14, 31, 594969, tzinfo=utc), verbose_name='Дата публікації')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(help_text='Максимум до 256 символів', max_length=256, verbose_name='Категорія')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='Максимум 256 символів', max_length=256, verbose_name='Заголовок')),
