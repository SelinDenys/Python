...
class Category(models.Model):
    category = models.CharField(u'Категорія', max_length=256, help_text=u'Максимум до 256 символів')
...
class Article(models.Model):
    title = models.CharField(u'Заголовок', max_length=256, help_text=u'Максимумм до 256 символів')
    ...
    main_page = models.BooleanField(u'Головна', default=False, help_text='Показувати на головній сторінці')
    ...
    def get_absolute_url(self):
        try:
            url = reverse("news-datail", kwargs={'year': self.pub_date.strftime("%Y"),
...
class ArticleImage(models.Model):
    ...
    title = models.CharField(u'Заголовок', max_length=256, help_text=u'Максимум 256 символів', blank=True)
